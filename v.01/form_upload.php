                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="form_upload.php">Documentação</a></li>
                  ...
                  <li><a><i class="fa fa-line-chart"></i> Investimentos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="plain_page.php">Meus Investimentos</a></li>
                      <li><a href="plain_page.php">Perfil de Investidor</a></li>
                    </ul>
                  </li>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Enviar múltiplos arquivos para análise</h2>
                  ...
                  <div class="x_content">
                    <p>Arraste e solte vários arquivos na área abaixo para enviá-los para análise ou clique para selecionar arquivos.</p>
                    <form action="uploadfile.php" class="dropzone" id="dropZone">
                      <input type="hidden" name="userID" id="userID" value="2345"/>
                    </form>
                    <br />
                    <br />
                    <br />
