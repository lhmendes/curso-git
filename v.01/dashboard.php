                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="plain_page.php">Indicadores Econômicos</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-money"></i> Empréstimos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="plain_page.php">Simular empréstimos</a></li>
                    </ul>
                  </li>
            ...
            <div class="row top_tiles">
              <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <h3>Indicador A</h3>
                  <p>Incluir aqui algum indicador.</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="icon"><i class="fa fa-comments-o"></i></div>
                  <div class="count">R$ 179,35</div>
                  <h3>Indicador B</h3>
                  <p>Incluir aqui um novo indicador.</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  <div class="icon"><i class="fa fa-sort-amount-desc red"></i></div>
                  <div class="count">R$ 3,72</div>
                  <h3>Dólar</h3>
                  <p>Variação de 0,00%</p>
                </div>
              </div>
                  ...
                  <div class="x_title">
                    ...
                    <div class="filter">
                      <div id="reportrange" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                        ...
                        <span>30 de Dezembro de 2018 - 28 de Janeiro de 2019</span> <b class="caret"></b>
                      </div>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  ...
                  <div class="x_content">
                    <article class="media event">
                      <a class="pull-left date" style="background-color:green">
                        <p class="month">Parc.</p>
                        <p class="day">01</p>
                      </a>
                      <div class="media-body">
                        <a class="title" href="#">Valor: R$ 135,20</a>
                        <p>Vence em: 23/06/2018 (Sáb)</br>
                           Pago em: 25/06/2018 (Seg)
                        </p>
                      </div>
                    </article>
                    <article class="media event">
                      ...
                      <div class="media-body">
                          <a class="title" href="#">Valor: R$ 135,20</a>
                          <p>Vence em: 23/07/2018 (Seg)</br>
                             Pago em: 23/07/2018 (Seg)
                          </p>
                        </div>
                    </article>
                    <article class="media event">
                      ...
                      <div class="media-body">
                          <a class="title" href="#">Valor: R$ 135,20</a>
                          <p>Vence em: 23/08/2018 (Qui)</br>
                             Pago em: 23/08/2018 (Qui)
                          </p>
                        </div>
                    </article>
                    <article class="media event">
                      ...
                      <div class="media-body">
                          <a class="title" href="#">Valor: R$ 135,20</a>
                          <p>Vence em: 23/09/2018 (Dom)</br>
                             Pago em: 24/09/2018 (Seg)
                          </p>
                        </div>
                    </article>
                    <article class="media event">
                      ...
                      <div class="media-body">
                          <a class="title" href="#">Valor: R$ 135,20</a>
                          <p>Vence em: 23/10/2018 (Ter)</br>
                             Pago em: 23/10/2018 (Ter)
                          </p>
                        </div>
                    </article>
                  </div>
